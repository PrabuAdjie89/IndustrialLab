    ...
    <div class="card-body py-4">
        ...
        <ul class="nav nav-tabs mb-4" id="peminjamanTab" role="tablist">
            ...
            <li class="nav-item">
                ...
                <button
                    class="nav-link {{ request('active_tab') != 'jadwal' ? 'active' : '' }}"
                    id="daftar-tab"
                    data-bs-toggle="tab"
        ...
        <div class="tab-content">
            ...
            {{-- TAB DAFTAR --}}
            <div
                class="tab-pane fade {{ request('active_tab') != 'jadwal' ? 'show active' : '' }}"
                id="daftar"
            >
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const activeTab = "{{ request('active_tab') }}";

        if (activeTab === 'jadwal') {

            const triggerEl =
                document.querySelector('#jadwal-tab');
