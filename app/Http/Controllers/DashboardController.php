...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $barangDipinjam = PeminjamanBarang::where('status', 'dipinjam')->count();
        $peminjamanMenunggu = PeminjamanBarang::where('status', 'menunggu')->count();
        $peminjamanRuanganMenunggu = PeminjamanRuangan::where('status', 'menunggu')->count();
